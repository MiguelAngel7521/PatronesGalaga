...
#include "IEstados.h"
#include "EstadoConArmamentoAdicional.generated.h"

UCLASS()
class ADAPTERPATERN1_API AEstadoConArmamentoAdicional : public AActor, public IIEstados
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AEstadoConArmamentoAdicional();
