...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABasico_Statics::NewProp_Jugador_MetaData[] = {
		{ "Category", "Estado Basico" },
		{ "ModuleRelativePath", "Basico.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABasico_Statics::NewProp_Jugador = { "Jugador", nullptr, (EPropertyFlags)0x0020080000020001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABasico, Jugador), Z_Construct_UClass_AAdapterPatern1Pawn_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABasico_Statics::NewProp_Jugador_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABasico_Statics::NewProp_Jugador_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABasico_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABasico_Statics::NewProp_Jugador,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ABasico_Statics::ClassParams = {
		...
		DependentSingletons,
		nullptr,
		Z_Construct_UClass_ABasico_Statics::PropPointers,
		InterfaceParams,
		UE_ARRAY_COUNT(DependentSingletons),
		0,
		UE_ARRAY_COUNT(Z_Construct_UClass_ABasico_Statics::PropPointers),
	...
	IMPLEMENT_CLASS(ABasico, 1695928359);
