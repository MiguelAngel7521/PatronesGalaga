...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AComponenteArmas_Statics::NewProp_ProyectilEnemigoClass_MetaData[] = {
		{ "Category", "Proyectil" },
		{ "ModuleRelativePath", "ComponenteArmas.h" },
	};
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AComponenteArmas_Statics::NewProp_ProyectilEnemigoClass = { "ProyectilEnemigoClass", nullptr, (EPropertyFlags)0x0014000000000001, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AComponenteArmas, ProyectilEnemigoClass), Z_Construct_UClass_AProjectileEnemigo_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_AComponenteArmas_Statics::NewProp_ProyectilEnemigoClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AComponenteArmas_Statics::NewProp_ProyectilEnemigoClass_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AComponenteArmas_Statics::NewProp_FireRate_MetaData[] = {
		{ "Category", "Proyectil" },
		{ "ModuleRelativePath", "ComponenteArmas.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AComponenteArmas_Statics::NewProp_FireRate = { "FireRate", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AComponenteArmas, FireRate), METADATA_PARAMS(Z_Construct_UClass_AComponenteArmas_Statics::NewProp_FireRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AComponenteArmas_Statics::NewProp_FireRate_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AComponenteArmas_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComponenteArmas_Statics::NewProp_ProyectilEnemigoClass,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AComponenteArmas_Statics::NewProp_FireRate,
	};
	...
	IMPLEMENT_CLASS(AComponenteArmas, 930515895);
